...
But what if your visualization library needs one row for each measure? So state, data type and the data. Maryland, Population, 6,165,000. That's one row. Then the next row is Maryland, Average Life Expectancy, 78. That's the next row. That's where recasting your data comes in. 
