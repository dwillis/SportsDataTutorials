...
logs <- read_csv("https://dwillis.github.io/sports-data-files/footballlogs24.csv")
...
Believe it or not, Minnesota and Iowa had the most takeaways in the Big Ten last season. And believe it: Maryland ended up at exactly zero on turnover margin.