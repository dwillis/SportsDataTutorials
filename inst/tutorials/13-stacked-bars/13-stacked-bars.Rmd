...
football <- read_csv("https://dwillis.github.io/sports-data-files/footballlogs24.csv")

big <- football |> 
  group_by(Conference, Team) |> 
  summarise(
    SeasonRushingYards = sum(RushYds),
    SeasonPassingYards = sum(PassYds),
...
What we have here is every game in college football in 2024. Let's quick take a glimpse.
...
And just like that ... Penn State comes out on top. Maryland? Tenth, on the strength of its passing game.