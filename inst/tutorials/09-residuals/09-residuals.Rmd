...
Let's go back to our net yards model from the previous lesson. We need data from the 2021 college football season. **For purposes of this exercise, you don't need to do this. The data is included here if you want to try this in your own notebook.**
...
* Our min and max go from -64 to positive 73
