...
Let's go back to our net yards model from the previous lesson. We need data from the 2022 college football season. **For purposes of this exercise, you don't need to do this. The data is included here if you want to try this in your own notebook.**
...
correlations <- read_csv("https://dwillis.github.io/sports-data-files/footballlogs22.csv")
...
We've seen this output before, but let's review because if you are using scatterplots to make a point, you should do this. First, note the Min and Max residual at the top. A team has underperformed the model by nearly 43 points (!), and a team has overperformed it by 42 points (!!). The median residual, where half are above and half are below, is just slightly above the fit line. Close here is good. 
...
First, note all of the biggest misses here are all blowout games. The worst games of the 2022 season, the worst being Western Kentucky vs Florida International. The model missed that differential by ... 70 points. The margin of victory? 73 points. In other words, this model is terrible. But let's look at it anyway. 
