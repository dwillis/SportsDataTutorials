...
*Write the code necessary to create the variables and set it to the number of goals Maryland scored in the 2022 season and the number of games played, then divide Goals by Games.*
...
If you watched a game, chances are you were going to see the Good Guys score quite a bit. 
