...
**To record a number, do _not_ use quotes.** So `myage <- 51` is how to set the value of the variable myage to 51. 
...
*Write the code necessary to create the variables and set it to the number of goals Maryland scored in the 2022 season and the number of games played.*
...
Using some rounding, the Terps scored 17.7 goals per game this season. So if you watched a game, chances are you were going to see the Good Guys score quite a bit. 
