...
Let's do something more real and calculate the number of goals per game the Maryland men's lacrosse team scored last season. To do this, we need to know the number of goals the team scored and the number of games they played. Then it's just simple division. 
