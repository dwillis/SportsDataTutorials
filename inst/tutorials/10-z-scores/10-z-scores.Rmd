...
Maryland is pretty good at volleyball, but they aren't great yet. Who is? The team we are playing on Sunday, #3 Nebraska. So let's use the 2021 Nebraska volleyball team, which was very good at volleyball. A few points from legendary. But were they the best Husker team since 2018, when they were also the national semifinalist? Also, how does Maryland measure up?
...
dllink <- download_link(
  link = "https://dwillis.github.io/sports-data-files/volleyball1812.csv",
...
seasons <- read_csv("https://dwillis.github.io/sports-data-files/volleyball1821.csv")
...
So now we have a dataframe called `teamzscore` that has 1323 volleyball teams with Z scores. What does it look like?
...
Maryland, a building program, isn't among the top teams on this list. One way to get on it? Beat teams like Nebraska, which the Terps play this Sunday.
