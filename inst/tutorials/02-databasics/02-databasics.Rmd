...
The site sports-reference.com takes NCAA (and other league) stats and puts them online. For instance, [here's their page on Maryland's basketball's game logs](https://www.sports-reference.com/cbb/schools/maryland/2024-gamelogs.html), which you should open now.
...
```
=IMPORTHTML("https://www.sports-reference.com/cbb/schools/maryland/2024-gamelogs.html", "table", 1)
```
