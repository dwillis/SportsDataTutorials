...
dllink <- download_link(
  link = "https://dwillis.github.io/sports-data-files/ncaa_womens_soccer_totals_2024.csv",
...
maxgames <- soccer |> summarize(max_games = max(games_played))
...
glue("Who is putting the most pressure on the keeper shot after shot?  {snipers$school_name}, who are on goal {format(snipers$SoGPct, digits=1)}% of the time.
     
     A note about this. Note that {snipers$school_name} played in {snipers$games_played} matches. The team that played the most played in {maxgames$max_games}. We'll learn how to deal with that in the next tutorial.")
``` 
...
glue("What conference do you not want to be a keeper?  The {confsnipers$conference_name} Conference, who are on goal {format(confsnipers$SoGPct, digits=1)}% of the time.")
``` 