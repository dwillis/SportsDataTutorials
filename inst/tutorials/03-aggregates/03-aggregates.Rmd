...
dllink <- download_link(
  link = "https://dwillis.github.io/sports-data-files/ncaa_volleyball_playermatchstats_2022.csv",
...
```
volleyballplayers <- read_csv("~/SportsData/ncaa_volleyball_playermatchstats_2022.csv")
```
...
volleyballplayers <- read_csv("https://dwillis.github.io/sports-data-files/ncaa_volleyball_playermatchstats_2022.csv")
...
One thing to keep in mind is this: You can use any of these verbs -- group_by, summarize, arrange -- on their own without the others. For example, what player had the most kills in 2022? To find this out, we don't need a group_by or summarize, so what goes in arrange is just the field name. Let's put this in order of kills.
