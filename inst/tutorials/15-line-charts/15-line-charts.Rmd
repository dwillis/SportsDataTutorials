...
Let's look at how we can answer this question: How good of a shooting team was Maryland's men basketball last season?
...
This data has every game from every team in it, so we need to use filtering to limit it, because we just want to look at Maryland. If you don't remember, flip back to lesson 5. Let's make a new dataframe called md for Maryland's games.
