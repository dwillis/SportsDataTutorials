...
Our chart is going to layer bigdiff, md and il in that order. We put bigdiff first because order matters and the first geom goes on the bottom.
...
ggplot() + 
  ...
  annotate("text", x=(as.Date("2022-02-10")), y=-70, label="Maryland") +
...
ggplot() + 
  ...
  annotate("text", x=(as.Date("2022-02-10")), y=-50, label="Maryland") +
  annotate("text", x=(as.Date("2022-03-01")), y=265, label="Illinois") +
  annotate("text", x=(as.Date("2022-03-01")), y=100, label="Wisconsin") +
  labs(
    x="Date", 
    y="Cumulative Point Differential", 
    title="Maryland lagged behind Big Ten leaders", 
    subtitle="The Terps rarely strayed from a small scoring advantage", 
